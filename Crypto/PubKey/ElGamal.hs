...
-- this number is usually called a and needs to be between
...
-- and needs to be between 0 and q (order of the group G).
--
...
-- and no signature is returned. The user of this function needs to retry
