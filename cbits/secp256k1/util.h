...
static  void *checked_realloc(const secp256k1_callback* cb, void *ptr, size_t size) {
 ...
 */
static  void *manual_alloc(void** prealloc_ptr, size_t alloc_size, void* base, size_t max_size) {
